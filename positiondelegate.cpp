...
PositionDelegate::PositionDelegate(QList<AgentType> *ats, VisualSettingsModel *model, QObject *parent)
...
void PositionDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option,
    ...
    const QModelIndex &index) const
{
        ...
        PositionDialog *editor = new PositionDialog(agentTypes, vsm, index.row());
