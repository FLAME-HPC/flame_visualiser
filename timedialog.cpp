    ...
    ui(new Ui::TimeDialog)
{
    ...
    connect(ui->spinBox_millisecond, SIGNAL(valueChanged(int)), this, SLOT(millisecondsChanged(int)));
    connect(ui->spinBox_second, SIGNAL(valueChanged(int)), this, SLOT(secondsChanged(int)));
    connect(ui->spinBox_minute, SIGNAL(valueChanged(int)), this, SLOT(minutesChanged(int)));
    connect(ui->spinBox_hour, SIGNAL(valueChanged(int)), this, SLOT(hoursChanged(int)));
    connect(ui->spinBox_day, SIGNAL(valueChanged(int)), this, SLOT(daysChanged(int)));
    connect(ui->checkBox_displayTimeInVisual, SIGNAL(clicked(bool)), this, SLOT(timeInVisualChanged(bool)));
